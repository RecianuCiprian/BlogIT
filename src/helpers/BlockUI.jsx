...
class BlockUi extends Component {
    ...
    render() {
        ...
        const classes = blocking ? `${css['block-ui']} ${className}` : className;
        ...
        return (
            <Tag {...attributes} className={classes} aria-busy={blocking} ref={this.setContainer}>
                ...
                {blocking &&
                <div className={css['block-ui-container']}
                     tabIndex="0"
                     ref={this.setBlocker}
                     onKeyUp={this.tabbedUpBottom}
                     onKeyDown={this.tabbedDownBottom}
                >
                    <div className={css["block-ui-overlay"]} />
                    <div className={css["block-ui-message-container"]}
                         ref={this.setMessageContainer}
                         style={{ top: keepInView ? this.state.top : undefined }}
                    >
                        <div className={css["block-ui-message"]}>
                            {message}
...
export default styleable(css)(BlockUi);